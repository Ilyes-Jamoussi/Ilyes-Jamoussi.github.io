...
const projects = [
    ...
    },
    {
        title: "Tetris",
        developmentDate: null,
        description: "Professional Tetris implementation featuring modern web technologies and clean architecture. Built with vanilla JavaScript ES6 modules, utilizing HTML5 Canvas for rendering and Web Audio API for dynamic sound synthesis. Implements two game modes (Modern with hold piece and ghost preview, Classic for traditional gameplay) with separate leaderboards. Features include state machine pattern for game flow, modular architecture with 11 independent modules, real-time audio system with background music and context-aware sound effects, interactive adaptive tutorial system, and comprehensive settings with localStorage persistence. Demonstrates expertise in game development, audio programming, and responsive design patterns.",
