...
const techLogos = {
    ...
    "PM2": "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/pm2/pm2-original.svg",
...
const projects = [
    ...
    },
    {
        ...
        liveUrl: "http://98.88.78.57",
        image: null
    },
    {
        title: "Tetris",
        developmentDate: null,
        description: "Tetris implementation featuring modern web technologies and clean architecture. Built with vanilla JavaScript ES6 modules, utilizing HTML5 Canvas for rendering and Web Audio API for dynamic sound synthesis. Implements two game modes (Modern with hold piece and ghost preview, Classic for traditional gameplay) with separate leaderboards. Features include state machine pattern for game flow, modular architecture with 11 independent modules, real-time audio system with background music and context-aware sound effects, interactive adaptive tutorial system, and comprehensive settings with localStorage persistence. Demonstrates expertise in game development, audio programming, and responsive design patterns.",
        technologies: ["JavaScript", "HTML5", "CSS3", "Python", "Pygame", "NumPy"],
